...
#if (`$Channels` )  // Normal more 1 to 16 channels
    #define `$INSTANCE_NAME`_GRIDMODE `$INSTANCE_NAME`_GRIDMODE_NORMAL
...
#else  // Single string wraped around a cylinder 
    #define `$INSTANCE_NAME`_GRIDMODE `$INSTANCE_NAME`_GRIDMODE_WRAP
